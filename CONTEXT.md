...
Preservar este archivo CONTEXT.md en el repositorio para documentar las metareglas de creación para éste proyecto.
...
El programa comenzará con Versión 1.0 build 000, cada push exitoso aumentará en 1 el número de build, el cual deberá
...
* Utilizar y validar el correcto uso de convenciones PEP257 para los docstrings.
* Ejecutar MyPy para los modulos que no sean explícitamente puestos fuera de su alcance.
